...
import random
import ctypes
from PyQt5.QtCore import Qt, QTimer, QPropertyAnimation, QPointF, QEasingCurve, QRectF
from PyQt5.QtWidgets import QApplication, QGraphicsView, QGraphicsScene, QGraphicsTextItem, QGraphicsObject, QSystemTrayIcon, QMenu, QAction
from PyQt5.QtGui import QFont, QColor, QBrush, QPainter, QIcon, QGuiApplication
import pygame
...
class FloatingHeartsView(QGraphicsView):
    def __init__(self):
        ...
        self.showFullScreen()
        # Lấy geometry của màn hình và cập nhật lại scene
        screen_rect = QGuiApplication.primaryScreen().geometry()
        self.setGeometry(screen_rect)
        self.scene.setSceneRect(screen_rect)
